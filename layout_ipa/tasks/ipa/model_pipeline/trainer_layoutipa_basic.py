...
class LayoutIpaBasicTrainer(Task):
    def __init__(self, **kwargs):
        ...
        self.weight_decay = kwargs.pop("weight_decay", 0.0001)
        ...
        self.args = kwargs
        super(LayoutIpaBasicTrainer, self).__init__(**kwargs)
    ...
    def train(
        ...
        for epoch in train_iterator:
            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                outputs = model(
                    screen=inputs_close_elements,
                    ui_element=inputs_ui,
                    instruction=inputs_instruction,
                )
    ...
    def eval(
        ...
        for batch in tqdm(dataloader, desc="Evaluating"):
            ...
            if preds is None:
                ...
                all_index = batch[14].detach().cpu().numpy()
                ...
                all_index = np.append(
                    all_index, batch[14].detach().cpu().numpy(), axis=0
                )
